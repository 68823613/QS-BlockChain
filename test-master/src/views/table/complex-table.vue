<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="科室" width="200px" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="职务" width="180px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.zhiwu }}</span>
        </template>
      </el-table-column>
      <el-table-column label="职称" width="180px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.zhicheng }}</span>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="职务" prop="zhiwu">
          <el-input :disabled="formDisabled" v-model="temp.zhiwu" />
        </el-form-item>
        <el-form-item label="职称" prop="zhicheng">
          <el-input :disabled="formDisabled" v-model="temp.zhicheng" />
        </el-form-item>
        ...
        <el-form-item label="工作经历" prop="history">
